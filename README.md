...
Delete Contact (with Undo feature)
...
Email format validation (@gmail, @yahoo, @outlook, etc.)

Country code validation (+91, +1, +44, +61)
...
Encrypted email addresses before saving
...
Persistent storage using contacts.txt

Auto-save on update/add/delete
